...
const { filenames } = mapping;
const fnToIdx = new Map(filenames.map((f, i) => [f, i]));
const groups: { id: string; name: string; images: string[] }[] = JSON.parse(
  readFileSync(groupsPath, "utf-8"),
);
...
const testPairs = [
  {
    cat: "SAME",
    a: "1e2cee94-9dc6-4f2e-94f9-9146950d109b",
    b: "8eac2757-b071-44a6-a91d-b772fddde592",
    name: "PinkBikini x PinkBikini2",
  },
  {
    cat: "SAME",
    a: "a6d1c65c-cbea-4105-af74-e0b9f9b95e51",
    b: "02e70989-426d-4805-b409-6215616f2a34",
    name: "WhiteSnow x WinterWhite2",
  },
  {
    cat: "SAME",
    a: "01a12d5a-0e1f-40b3-8935-30e8d5d8c102",
    b: "2f66645e-504b-42c9-8b39-3e4e779105c7",
    name: "StrawRobe2 x StrawRobeStrip",
  },
  {
    cat: "SAME",
    a: "d0cbe1d7-ea6d-4678-95d2-324b1c11684d",
    b: "ac74c692-ecb6-42e7-82c2-e8ecc1be7522",
    name: "PinkChains x Makima",
  },
  {
    cat: "SIM",
    a: "de990bc6-d3a7-4f12-b522-075263401ce3",
    b: "2a679639-574d-4c46-b5ca-1aed37de7fdb",
    name: "WhiteBody x TransWhite",
  },
  {
    cat: "SIM",
    a: "11298375-d7ed-490d-a681-29053f560a85",
    b: "3063db5d-737e-406e-9f54-8a3962925e41",
    name: "OrangeBikini x RedBikini",
  },
  {
    cat: "SIM",
    a: "7b065238-5677-46b9-a9cc-adbf97fbb542",
    b: "5944be9e-d18e-4179-9b35-10abc8ed1661",
    name: "PalePink x WhitePoolside",
  },
  {
    cat: "SIM",
    a: "69e87ffe-8124-42ca-bc48-50a81c263c4e",
    b: "d0cbe1d7-ea6d-4678-95d2-324b1c11684d",
    name: "DevilPrep x PinkChains",
  },
  {
    cat: "NEVR",
    a: "01803486-5fe0-4ea2-8b6e-a22fabf13653",
    b: "40e5c93e-0490-4767-9c3f-29caaccce340",
    name: "ValentG x SnowElves",
  },
  {
    cat: "NEVR",
    a: "e1853e6f-9458-416b-83f7-02f5bf9b0d29",
    b: "547c6d66-243d-43dc-9ec3-7d416f96a916",
    name: "NeonLatex x SexyShower",
  },
  {
    cat: "NEVR",
    a: "d0cbe1d7-ea6d-4678-95d2-324b1c11684d",
    b: "dbf6d6a2-a543-4e6d-a4ca-a3022f79351e",
    name: "PinkChains x BlackDevil",
  },
  {
    cat: "NEVR",
    a: "70928dcf-5f8b-4396-bb8a-e5b2c4b9f9f0",
    b: "233e9056-030d-4d38-b018-11ef40038979",
    name: "Venom x NaturalWaves",
  },
];
...
console.log(
  "For each image, find semantic NN in other group, but only count if color dist < threshold",
);

for (const colorThresh of [0.05, 0.08, 0.1, 0.15, 0.2]) {
